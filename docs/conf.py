# -*- coding: utf-8 -*-
#
# napari-nikon-nd2 documentation build configuration file, created by
...
project = u'napari-nikon-nd2'
copyright = u'2015, Chris Wood'
author = u'Chris Wood'
...
man_pages = [
    (master_doc, 'napari-cookiecutterplugin_name', u'napari-nikon-nd2 Documentation',
     [author], 1)
]
